...
jQuery.extend({
	...
	/*add by liuwenqing 2015-1-27 增加文本参数 start */
	createUploadForm : function(id, fileElementId, data) {
		/*add by liuwenqing 2015-1-27 增加文本参数 end */
		//create form 
	...
	ajaxFileUpload : function(s) {
		...
		/*modify by liuwenqing 2015-1-27 增加文本参数 start */
		var form = jQuery.createUploadForm(id, s.fileElementId, data);
		/*modify by liuwenqing 2015-1-27 增加文本参数 end */
