package com.android.commonapp.activity.boutique;
 ...
 * 精品知识
 */
public class Boutique_Activity extends BaseActivity<BoutiqueContact.presenter> implements BoutiqueContact.view,
OnClickListener,CustomerListView.Callback {
	...
	private ArrayList<BoutiqueModel> kngcourseArrayList = new ArrayList<BoutiqueModel>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		RefreshHandler = new MHandler(Boutique_Activity.this);
	...
	@Override
	public void success(List<BoutiqueModel> list) {
		onLoad();
		linkDead();
		isSucceed = true;
	...
	@Override
	public BoutiqueContact.presenter initPresenter() {
		return new BoutiquePresenter(this);
	}

	class MHandler extends Handler {
		final WeakReference<Boutique_Activity> activityWeakReference;

		MHandler(Boutique_Activity activity) {
			this.activityWeakReference = new WeakReference<>(activity);
		}

		@Override
		public void handleMessage(Message msg) {
			Boutique_Activity activity = activityWeakReference.get();
			if (activity == null) {
				return;
			}
			switch (msg.what) {
	...
	private void initzhishiType(){
		presenter.getKnowledgeBoutique(id,String.valueOf(start), String.valueOf(end));
	}
	...
	public View getView(final int arg0, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			view = LayoutInflater.from(Boutique_Activity.this).inflate(R.layout.adapter_knowledge_item, null);
		...
		viewHolder.knowledgecouese_name_text.setText(kngcourseArrayList.get(arg0).getBoutiqueseriesname());//名称
		viewHolder.zskj_kstime_text.setText(kngcourseArrayList.get(arg0).getBoutiqueseriesnum()+"课时  ");//课时
		viewHolder.zskj_timelong_text.setText(kngcourseArrayList.get(arg0).getBoutiqueseriestimelong());//时长
		...
		view.setOnClickListener(new OnClickListener() {
			...
			if(preferencesUtil.getIsLog()) {
				Intent intent = new Intent(Boutique_Activity.this, Video_Activity.class);
				intent.putExtra("id",kngcourseArrayList.get(arg0).getId());
				intent.putExtra("type","jingpin");
				Boutique_Activity.this.startActivity(intent);
			}else{
				Intent intent3 = new Intent(Boutique_Activity.this, LoginActivity.class);
				ScreenManager.getScreenManager().startPage(Boutique_Activity.this, intent3, true);
			}
			}
		});
